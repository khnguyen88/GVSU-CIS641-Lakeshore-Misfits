...
const MockSite = () => {
  ...
  return (
  <div className="MockSite" data-testid="MockSite" style={{backgroundColor: palette.colors[2]}}>
    <h1 style={{color: palette.colors[4]}}> Mock Site Page</h1>
     <section>
      <h2 style={{color: palette.colors[3]}}>Title 1</h2>
  ...
  <aside style={{backgroundColor: palette.colors[1]}} >
    ...
    <button className="button" style={{backgroundColor: palette.colors[2]}}>Test Button</button>
	</aside>
  </div> );
};
