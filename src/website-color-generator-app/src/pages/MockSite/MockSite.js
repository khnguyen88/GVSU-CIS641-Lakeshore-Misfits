...
const MockSite = () => {
  ...
  const mockNavItems = document.querySelectorAll('.inactive a');
  ...
  return (
    ...
    <ul className="mock-nav" style={{backgroundColor: palette.colors[4]}}>
      <li className="mock-nav-item active" style={{backgroundColor: palette.colors[2]}}><a href="" style={{color: palette.colors[2].isLight() ? palette.colors[4] : palette.colors[0]}}>Home</a></li>
      <li className="mock-nav-item inactive"><a href="">Link 1</a></li>
      <li className="mock-nav-item inactive"><a href="">Link 2</a></li>
      <li className="mock-nav-item inactive"><a href="">Link 3</a></li>
    </ul> 
